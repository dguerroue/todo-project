  ...
  return (
    <div className="checkbox-item flex gap-2 items-center">
      <label htmlFor={labelSlug} className="inline-flex items-center gap-3 cursor-pointer">
        <input type="checkbox" className="size-5 rounded border-gray-300 shadow-sm cursor-pointer" id={labelSlug} checked={isChecked} onChange={(event) => handleCheckChange(event.target.checked)} />
